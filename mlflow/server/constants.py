...
# Trace repository root for trace span archival (used with --trace-archival-location).
# When unset, workers use the artifact destination as the archive repository root.
