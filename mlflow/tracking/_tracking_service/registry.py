...
class TrackingStoreRegistry(StoreRegistry):
    ...
    def get_store(self, store_uri=None, artifact_uri=None, trace_archival_uri=None):
        ...
        return self._get_store_with_resolved_uri(
            resolved_store_uri, artifact_uri, trace_archival_uri
        )

    @lru_cache(maxsize=100)
    def _get_store_with_resolved_uri(
        self, resolved_store_uri, artifact_uri=None, trace_archival_uri=None
    ):
        """
        ...
        with _building_store_lock:
            ...
            return builder(
                store_uri=resolved_store_uri,
                artifact_uri=artifact_uri,
                trace_archival_uri=trace_archival_uri,
            )
