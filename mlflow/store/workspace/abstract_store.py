...
class AbstractStore(ABC):
    ...
    def resolve_trace_archival_root(
        ...
        """
        Allow a provider to customize the trace repository root per workspace.

        Returns:
            The workspace-specific trace archival root if set, otherwise None to use the global.
        """
        return None
